...
namespace nspMap {
	...
	public:
		...
		public:
			...
			pNode<value_type>& operator*() const { return *static_cast<pNode<value_type>*>(m_ptr); }		// static_cast is necessary, instead compiler constructs temporary copy which could unintentionaly release resources
